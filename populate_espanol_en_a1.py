#!/usr/bin/env python3
"""
Populate espanol-en A1 with vocabulary, grammar, and writing chapters.
Scaffolding: vocabulary (12), grammar (24), writing (3)
"""

import os
import json

BASE_PATH = '/home/user/wordplay/espanol-en/a1'
...
VOCAB_CHAPTERS = {
    'family': {
        ...
        'title': 'Family',
        'words': [
            {'word': 'padre', 'ipa': 'pɑˈðɾe', 'def': 'father', 'ex': 'Mi <b>padre</b> es ingeniero.'},
            {'word': 'madre', 'ipa': 'ˈmɑðɾe', 'def': 'mother', 'ex': 'Mi <b>madre</b> trabaja en un hospital.'},
            {'word': 'hijo', 'ipa': 'ˈiχo', 'def': 'son', 'ex': 'Mi <b>hijo</b> tiene cinco años.'},
            {'word': 'hija', 'ipa': 'ˈiχɑ', 'def': 'daughter', 'ex': 'Mi <b>hija</b> es estudiante.'},
            {'word': 'hermano', 'ipa': 'eɾˈmɑno', 'def': 'brother', 'ex': 'Mi <b>hermano</b> vive en Barcelona.'},
            {'word': 'hermana', 'ipa': 'eɾˈmɑnɑ', 'def': 'sister', 'ex': 'Mi <b>hermana</b> es médica.'},
            {'word': 'abuelo', 'ipa': 'ɑˈβwelo', 'def': 'grandfather', 'ex': 'Mi <b>abuelo</b> tiene ochenta años.'},
            {'word': 'abuela', 'ipa': 'ɑˈβwelɑ', 'def': 'grandmother', 'ex': 'Mi <b>abuela</b> vive con nosotros.'},
            {'word': 'tío', 'ipa': 'ˈtio', 'def': 'uncle', 'ex': 'Mi <b>tío</b> es profesor.'},
            {'word': 'tía', 'ipa': 'ˈtiɑ', 'def': 'aunt', 'ex': 'Mi <b>tía</b> vive en Madrid.'},
            {'word': 'primo', 'ipa': 'ˈpɾimo', 'def': 'cousin (m)', 'ex': 'Mi <b>primo</b> es muy divertido.'},
            {'word': 'prima', 'ipa': 'ˈpɾimɑ', 'def': 'cousin (f)', 'ex': 'Mi <b>prima</b> estudia danza.'},
            {'word': 'esposo', 'ipa': 'esˈposo', 'def': 'husband', 'ex': 'Mi <b>esposo</b> es ingeniero.'},
            {'word': 'esposa', 'ipa': 'esˈposɑ', 'def': 'wife', 'ex': 'Mi <b>esposa</b> trabaja como abogada.'},
            {'word': 'novio', 'ipa': 'noˈβio', 'def': 'boyfriend/fiancé', 'ex': 'Mi <b>novio</b> es muy amable.'},
            {'word': 'novia', 'ipa': 'noˈβiɑ', 'def': 'girlfriend/fiancée', 'ex': 'Mi <b>novia</b> es arquitecta.'},
            {'word': 'familia', 'ipa': 'fɑˈmiliɑ', 'def': 'family', 'ex': 'Mi <b>familia</b> es muy grande.'},
            {'word': 'padres', 'ipa': 'pɑˈðɾes', 'def': 'parents', 'ex': 'Mis <b>padres</b> son jubilados.'},
            {'word': 'hijo único', 'ipa': 'ˈiχo ˈuniko', 'def': 'only child', 'ex': 'Es <b>hijo único</b> en su familia.'},
            {'word': 'marido', 'ipa': 'mɑˈɾiðo', 'def': 'husband (informal)', 'ex': 'Mi <b>marido</b> me ayuda mucho.'},
        ]
    },
    'colours': {
        'slug': 'colours',
        'title': 'Colours',
        'words': [
            {'word': 'rojo', 'ipa': 'ˈɾoχo', 'def': 'red', 'ex': 'Me gusta la manzana <b>roja</b>.'},
            {'word': 'azul', 'ipa': 'ɑˈθul', 'def': 'blue', 'ex': 'El cielo es <b>azul</b>.'},
            {'word': 'amarillo', 'ipa': 'ɑmɑˈɾiʎo', 'def': 'yellow', 'ex': 'El sol es <b>amarillo</b>.'},
            {'word': 'verde', 'ipa': 'ˈβeɾðe', 'def': 'green', 'ex': 'La hierba es <b>verde</b>.'},
            {'word': 'blanco', 'ipa': 'ˈβlɑŋko', 'def': 'white', 'ex': 'La nieve es <b>blanca</b>.'},
            {'word': 'negro', 'ipa': 'ˈneɣɾo', 'def': 'black', 'ex': 'Mi gato es <b>negro</b>.'},
            {'word': 'gris', 'ipa': 'ɡɾis', 'def': 'grey', 'ex': 'Las nubes son <b>grises</b>.'},
            {'word': 'marrón', 'ipa': 'mɑˈɾon', 'def': 'brown', 'ex': 'El árbol tiene un tronco <b>marrón</b>.'},
            {'word': 'naranja', 'ipa': 'nɑˈɾɑŋχɑ', 'def': 'orange', 'ex': 'La naranja es de color <b>naranja</b>.'},
            {'word': 'rosa', 'ipa': 'ˈɾosɑ', 'def': 'pink', 'ex': 'Mi habitación es <b>rosa</b>.'},
            {'word': 'púrpura', 'ipa': 'ˈpuɾpuɾɑ', 'def': 'purple', 'ex': 'Llevo un vestido <b>púrpura</b>.'},
            {'word': 'turquesa', 'ipa': 'tuɾˈkesɑ', 'def': 'turquoise', 'ex': 'El mar es <b>turquesa</b>.'},
        ]
    },
    'animals': {
        'slug': 'animals',
        'title': 'Animals',
        'words': [
            {'word': 'gato', 'ipa': 'ˈɡɑto', 'def': 'cat', 'ex': 'Mi <b>gato</b> es muy cariñoso.'},
            {'word': 'perro', 'ipa': 'ˈpeɾo', 'def': 'dog', 'ex': 'El <b>perro</b> corre en el parque.'},
            {'word': 'pájaro', 'ipa': 'ˈpɑχɑɾo', 'def': 'bird', 'ex': 'Un <b>pájaro</b> canta en el árbol.'},
            {'word': 'pez', 'ipa': 'peθ', 'def': 'fish', 'ex': 'El <b>pez</b> nada en el acuario.'},
            {'word': 'caballo', 'ipa': 'kɑˈβɑʎo', 'def': 'horse', 'ex': 'El <b>caballo</b> es muy fuerte.'},
            {'word': 'vaca', 'ipa': 'ˈβɑkɑ', 'def': 'cow', 'ex': 'La <b>vaca</b> da leche.'},
            {'word': 'cerdo', 'ipa': 'ˈθeɾðo', 'def': 'pig', 'ex': 'El <b>cerdo</b> vive en la granja.'},
            {'word': 'oveja', 'ipa': 'oˈβeχɑ', 'def': 'sheep', 'ex': 'La <b>oveja</b> tiene lana blanca.'},
            {'word': 'pollo', 'ipa': 'ˈpoʎo', 'def': 'chicken', 'ex': 'El <b>pollo</b> canta por la mañana.'},
            {'word': 'león', 'ipa': 'leˈon', 'def': 'lion', 'ex': 'El <b>león</b> es el rey de la selva.'},
            {'word': 'elefante', 'ipa': 'eleˈfɑnte', 'def': 'elephant', 'ex': 'El <b>elefante</b> es muy grande.'},
            {'word': 'oso', 'ipa': 'ˈoso', 'def': 'bear', 'ex': 'El <b>oso</b> es muy fuerte.'},
            {'word': 'araña', 'ipa': 'ɑˈɾɑnɑ', 'def': 'spider', 'ex': 'La <b>araña</b> hace una tela.'},
            {'word': 'serpiente', 'ipa': 'seɾpjˈente', 'def': 'snake', 'ex': 'La <b>serpiente</b> es peligrosa.'},
            {'word': 'mariposa', 'ipa': 'mɑɾiˈposɑ', 'def': 'butterfly', 'ex': 'La <b>mariposa</b> es muy bonita.'},
        ]
    }
}

def create_vocab_flashcards(chapter, chapter_slug, chapter_num):
    """Generate flashcards.html for a vocabulary chapter"""
    words_json = json.dumps(chapter['words'])
    html = f'''<!DOCTYPE html>
<html lang="en">
<head>
...
<title>{chapter['title']} — Flashcards | Word Play</title>
...
.fc-audio-btn{{background:none;border:1px solid var(--hairline);border-radius:4px;padding:5px 12px;font-family:var(--font-sans);font-size:.65rem;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:var(--muted);cursor:pointer;margin-top:10px}}
...
.match-item{{padding:12px 14px;border:1.5px solid var(--hairline);border-radius:6px;cursor:pointer;font-size:.9rem;color:var(--ink);transition:border-color .15s,background .15s;user-select:none}}
...
.match-score{{font-family:var(--font-sans);font-size:.85rem;color:var(--muted);text-align:center;margin-bottom:16px}}
...
.wl-word{{font-weight:700;font-size:1rem;min-width:160px}}
...
<div class="container">
  ...
  <div class="vocab-page">
    ...
    <div style="font-family:var(--font-sans);font-size:.75rem;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:var(--muted);margin-bottom:16px">{len(chapter['words'])} words · tap card to reveal</div>
...
(function(){{
  ...
  if (!ta) return;
  var KEY = 'wp_notes_a1_{chapter_slug}';
...
# Generate vocabulary flashcards for first 3 chapters
for idx, (slug, chapter) in enumerate(list(VOCAB_CHAPTERS.items())[:3], 1):
    fpath = f'{BASE_PATH}/vocabulary/{slug}/flashcards.html'
    os.makedirs(os.path.dirname(fpath), exist_ok=True)
    html = create_vocab_flashcards(chapter, slug, idx)
    with open(fpath, 'w') as f:
        f.write(html)
    print(f'✓ Created {slug}/flashcards.html')

print('\nVocabulary flashcards complete. Next: slides, worksheets, game pages, and grammar.')
